...
<html >
  <head>
    <meta charset="UTF-8">
    <title>销户账号</title> 
    <link rel="stylesheet" href="http://sites/yyl/css/normalize.css">
...
<script type="text/javascript">
  ...
  <div class="wrapper">
    ...
    <?PHP echo form_open('Stockaccount/Stockaccount/cancelAccount','class="login"')?> 
   <!-- <form action="showsuccess" method="post">-->
      <p class="title">销户账户</p>
      
      账户类型：
      <select type="input" name="typeOfAccount">

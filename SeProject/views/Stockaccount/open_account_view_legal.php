...
<script type="text/javascript">
  ...
  <div class="wrapper">
    ...
    <?PHP echo form_open('Stockaccount/Stockaccount/indexLegal','class="login"')?> 
   <!-- <form action="showsuccess" method="post">-->
      <p class="title">开立法人账户</p>
      
      <table border="0" cellpadding="0" cellspactin="0" width="650px">
      <tr>
        <td width="30%">法人股票账户号码：</td>
        <td width="70%"><input type="input" name="accountId" placeholder="" /><br>  </td>
      </tr>
      <tr>
        <td>账户密码：</td>
      ...
      <tr>
        <td>有效的法人注册登记号码：</td>
        <td><input type="input" name="rgstNumber" placeholder="" /> <br></td>
      </tr>
      <tr>
        <td>营业执照号码：</td>
        <td><input type="input" name="bLisnNumber" placeholder="" /> <br></td>
      </tr>
      <tr>
        <td>法定代表人的身份证号码：</td>
      ...
      <tr>
        <td>法定代表人授权证券交易执行人姓名：</td>
        <td><input type="input" name="authName" placeholder="" /> <br></td>
      </tr>
      <tr>
        <td width="30%">授权人有效身份证号码：</td>
        <td><input type="input" name="authIdNumber" placeholder="" /> <br></td>
      </tr>
      <tr>
        <td width="30%">授权人联系电话：</td>
        <td><input type="input" name="authPhoneNumber" placeholder="" /> <br></td>
      </tr>
      <tr>
        <td width="30%">授权人地址：</td>
        <td><input type="input" name="authhouAddress" placeholder="" /> </td>
      </tr>
      </table>

		...
		"fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			jQuery(nPaging).append(
				'<ul class="pagination pagination-sm">'+
					'<li class="prev disabled"><a href="#" style="height:27.33"><i class="entypo-left-open"></i></a></li>'+
					'<li class="next disabled"><a href="#" style="height:27.33"><i class="entypo-right-open"></i></a></li>'+
				'</ul>'
			);
